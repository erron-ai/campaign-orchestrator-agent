"""Core logic for campaign_orchestrator_agent."""
...
def analyze_records(records: list[dict[str, Any]]) -> AnalysisResult:
    ...
    return AnalysisResult(
        ...
        score=score,
        summary=f"{summary} result for: ABM campaign agent for account scoring, channel selection, and personalized sequencing.",
        signals=signals,
    )
